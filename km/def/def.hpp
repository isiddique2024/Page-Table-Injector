...
namespace globals {
  ...
  function_types::ke_flush_single_tb_t ke_flush_single_tb = nullptr;
  ...
  function_types::mm_get_physical_memory_ranges_t mm_get_physical_memory_ranges = nullptr;
  function_types::mm_is_address_valid_t mm_is_address_valid = nullptr;

  uintptr_t mm_highest_physical_page = 0;
  uintptr_t mm_lowest_physical_page = 0;
  ...
  function_types::ps_get_process_exit_status_t ps_get_process_exit_status = nullptr;
  function_types::ps_set_create_thread_notify_routine_t ps_set_create_thread_notify_routine =
      nullptr;
